...
$container = $_POST["container"]; // This is the container to be moved.
...
if ($old_location !== null and $old_location !== "" and $old_space !== null and $old_space !== "" and $old_container !== null and $old_container !== "") { // Check to see if information was entered for the old container information.
    if ($new_location !== null and $new_location !== "") { // Check to make sure a new location was specified.
        if ($new_space !== null and $new_space !== "") { // Check to make sure a new space was specified.
            $item_database["locations"][$new_location]["spaces"][$new_space]["containers"][$container] = $item_database["locations"][$old_location]["spaces"][$old_space]["containers"][$container]; // Move the original container's information to the new container.
            unset($item_database["locations"][$old_location]["spaces"][$old_space]["containers"][$container]); // Remove the container from the old location.
    ...
    <body>
        ...
        <div class="new-item">
            <form method="POST">
                ...
                <label for="container">Container Name: </label><input type="text" name="container" id="container" placeholder="Container" required><br>
                <hr>
